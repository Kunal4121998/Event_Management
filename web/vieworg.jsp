...
%>
  ...
  <nav class="navbar navbar-dark navbar-expand-sm  fixed-top">
                   ...
                   <li class="nav-item dropdown active">
                       ...
                       <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item active" href="vieworg.jsp?page2=1">Organiser</a>
                            <div class="dropdown-divider"></div>
  ...
  <div class="card card-container">
                    <h3 class="card-header abc text-white text-center">Organiser Details</h3>
                    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-4 offset-5 ">
                <form action="addorg.jsp" method="get">
                    <button class="btn btn-primary">Add Organiser</button>
                </form>
            </div>            
            </div>
        </div>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                     <%
                          ...
                          String spaceid=request.getParameter("page2");
                        ...
                        String data;
                        if(query!=null){
                            data="SELECT * FROM `organiser` where Name like'%"+query+"%' or Mobile like'%"+query+"%' or Email like'%"+query+"%' or Event like'%"+query+"%'";
                        }else
                        {
                            data="SELECT * FROM organiser limit "+(pageid-1)+","+total;
                        }
                        ...
                        while(rs.next()){
                            ...
                            <tr>
                                 ...
                                 <td>
                                     <a href='editorganiser.jsp?u=<%=rs.getString("id")%>' class="btn btn-warning">Edit</a>
                                      <a href='deleteorganiser.jsp?d=<%=rs.getString("id")%>' class="btn btn-danger">Delete</a>
                                 </td>
                            </tr>
                            <%
                        }
  ...
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="vieworg.jsp?page2=1">1</a></li>
    <li class="page-item"><a class="page-link" href="vieworg.jsp?page2=2">2</a></li>
