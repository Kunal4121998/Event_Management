             ...
             <nav class="navbar navbar-dark navbar-expand-sm fixed-top">
                   ...
                   <li class="nav-item dropdown">
                       ...
                       <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item active" href="addparticipant.jsp" >Participant</a>
                            <div class="dropdown-divider"></div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center justify-content-sm-center">
                <div class="col-12 col-sm-6 col-md-3">   
                    <form class="form-container" action="addparticipant" method="post" name="form1">
                        ...
                        <div class="form-group">
                         ...
                         <input type="number" class="form-control" name="pmobile" placeholder="Enter Mobile no." required="enter mobile">
