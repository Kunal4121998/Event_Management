...
public class add_participant extends HttpServlet {
    protected void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException{
        ...
        String subject="Participant Details";
        String msg="Your  details are: Email: "+pvemail+"  \n  "+"Phone no. "+pvmob+"\n"+"Event: "+pvevent+"\n"+"Amount Paid: "+pvapaid+"\n"+"Amount Due: "+pvdue+"\n"+"No. of Team Members: "+pvteam+"\n"+"College nmae: "+pvclgname;
         ...
         props.put("mail.smtp.host","smtp.gmail.com");
          props.put("mail.smtp.port","587");
             ...
             try{
                    ...
                    String final_Text="Dear: "+pv2name+"\n"+"Message: "+msg;
                    textpart.setText(final_Text);
                    multipart.addBodyPart(textpart);
                    message.setContent(multipart);
                    message.setSubject("Participant Details");
