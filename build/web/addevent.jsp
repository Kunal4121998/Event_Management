             ...
             <nav class="navbar navbar-dark navbar-expand-sm fixed-top">
                   ...
                   <li class="nav-item dropdown">
                       ...
                       <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item active" href="addevent.jsp">Event</a>
          ...
          <div class="container-fluid">
            <div class="row justify-content-center justify-content-sm-center">
                <div class="col-12 col-sm-6 col-md-3">  
                    <form class="form-container" action="addevent" method="post">
                        <div class="form-group">
                            <h3>Add Event</h3>
            <p>Event Name</p>
            <input type="text" class="form-control" name="ename" placeholder="Enter Name" required="name">
                        </div>
                        <div class="form-group">
            <p>Event Type</p>
            <input type="text" name="etype" class="form-control" placeholder="Enter Type">
                        </div>
                        <div class="form-group">
            <p>Event Head</p>
            <input type="text" class="form-control" name="ehead" placeholder="Enter Head">
                        </div>
                         <div class="form-group">
            <p>Event Venue</p>
            <input type="text" name="evenue" class="form-control" placeholder="Enter Venue">
                         </div>
                         <div class="form-group">
            <p>Event Time</p>
            <input type="text" class="form-control" name="ettime" placeholder="Event Time">
                         </div>
